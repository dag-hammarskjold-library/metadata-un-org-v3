...
export default {
    ...
    data() {
        return {
            ...
            language: "en",
            relTypes: [
                {'name': 'Broader Terms', 'accessor': 'broaderTerms', 'predicate': `${skos}broader`},
                {'name': 'Narrower Terms', 'accessor': 'narrowerTerms', 'predicate': `${skos}narrower`},
                {'name': 'Related Terms', 'accessor': 'relatedTerms', 'predicate': `${skos}related`},
            ]
        }
    },
...
<div class="row">
        <div class="col-7">
            ...
            <div class="row my-2" v-for="rt in relTypes" :key="rt.accessor">
                <div class="col-3" v-if="this.concept[rt.accessor].length > 0"><span>{{ $t(`message.${rt.accessor}`)}}</span></div>
                <div class="col-9" v-if="this.concept[rt.accessor].length > 0">
